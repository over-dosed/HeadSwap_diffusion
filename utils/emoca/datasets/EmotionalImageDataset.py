...
from HSD.utils.emoca.transforms.keypoints import KeypointScale, KeypointNormalization
from HSD.utils.emoca.utils.FaceDetector import load_landmark
...
class EmotionalImageDatasetBase(torch.utils.data.Dataset):
    ...
    def _plot(self, axs, K, k, sample):
        ...
        from HSD.utils.emoca.utils.DecaUtils import tensor_vis_landmarks
