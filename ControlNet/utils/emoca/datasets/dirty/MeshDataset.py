...
# from HSD.utils.emoca.utils.mesh import load_mesh
...
class EmoSpeechDataModule(pl.LightningDataModule):
    ...
    def _raw_audio_to_deepspeech(self, audio_scaler=32500):
        from HSD.utils.emoca.utils.DeepSpeechConverter import DeepSpeechConverter
...
def main2():
    ...
    pass
    # import deepspeech
    # model_file_path = '/home/rdanecek/Workspace/Data/deepspeech/deepspeech-0.9.2-from HSD.utils.emoca.models.pbmm'
