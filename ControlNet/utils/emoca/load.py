...
from HSD.utils.emoca.DECA import DecaModule
from HSD.utils.emoca.models.IO import locate_checkpoint
...
def replace_asset_dirs(asset_dir, cfg, output_dir : Path, ): 
...
def load_model(path_to_models, asset_dir, 
              run_name,
              stage,
              relative_to_path=None,
              replace_root_path=None,
    ...
    conf = replace_asset_dirs(asset_dir, conf, Path(path_to_models) / run_name)
