...
def main(args):
    ...
    for i in tqdm(range(len(testdata))):
        ...
        if args.saveVis:
            ...
            if args.render_orig:
                cv2.imwrite(os.path.join(savefolder, name + '_vis_original_size.jpg'), deca.visualize(orig_visdict, size=512))
        if args.saveImages:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--inputpath', default='/data0/wc_data/VFHQ/test/Clip+RfHY644z7aI+P0+C1+F2537-2828/00000004.png', type=str,
